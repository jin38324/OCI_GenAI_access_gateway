...
from oci.util import AUTHENTICATION_TYPE_FIELD_NAME, get_signer_from_authentication_type
...
class DataScienceAiInferenceClient(object):
    ...
    def chat(self, endpoint, chat_details, **kwargs):
        ...
        return self.call_api(
            endpoint=endpoint, is_stream=is_stream, chat_details=chat_details
        )
